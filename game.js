...
var a2=['A2','B1','B3','a','a'],a4=['A4','B3','B5','a','a'],a6=['A6','B5','B7','a','a'],a8=['A8','B7','a','a'],b1=['B1','C2','a','a','A2'],b3=['B3','C2','C4','A2','A4'],b5=['B5','C4','C6','A4','A6'],b7=['B7','C6','C8','A6','A8'],c2=['C2','D1','D3','B1','B3'],c4=['C4','D3','D5','B3','B5'],c6=['C6','D5','D7','B5','B7'],c8=['C8','D7','a','B7','B7']
var d1=['D1','E2','a','a','C2'],d3=['D3','E2','E4','C2','C4'],d5=['D5','E4','E6','C4','C6'],d7=['D7','E6','E8','C6','C8'],e2=['E2','F1','F3','D1','D3'],e4=['E4','F3','F5','D3','D5'],e6=['E6','F5','F7','D5','D7'],e8=['E8','F7','a','D7','D7']
var f1=['F1','G2','a','a','E2'],f3=['F3','G2','G4','E2','E4'],f5=['F5','G4','G6','E4','E6'],f7=['F7','G6','G8','E6','E8'],g2=['G2','H1','H3','F1','F3'],g4=['G4','H3','H5','F3','F5'],g6=['G6','H5','H7','F5','F7'],g8=['G8','H7','a','F7','F7'],h1=['H1','a','a','a','G2'],h3=['H3','a','a','G2','G4'],h5=['H5','a','a','G4','G6'],h7=['H7','a','a','G6','G8']
